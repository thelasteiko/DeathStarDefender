...
function AboutScene(gameEngine) {
    Scene.call(this, gameEngine);
    this.startInput();
}

AboutScene.prototype = new Scene();
AboutScene.prototype.constructor = AboutScene;

AboutScene.prototype.init = function (ctx) {
...
AboutScene.prototype.startInput = function () {
    if (!this.ctx) return;
    var that = this;
...
AboutScene.prototype.draw = function (ctx) {
    ctx.save();
